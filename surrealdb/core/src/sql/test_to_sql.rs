...
// Expression: Alter
#[case::expr_alter(Expr::Alter(Box::new(AlterStatement::Table(AlterTableStatement { name: Expr::Table("user".into()), if_exists: false, schemafull: AlterKind::None, permissions: None, changefeed: AlterKind::None, comment: AlterKind::None, kind: None, id_generation: None, compact: false }))), "ALTER TABLE user", "ALTER TABLE user")]
// Expression: Info
#[case::expr_info(
